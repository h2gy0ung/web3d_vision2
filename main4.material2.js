...
//physics
  _setupModel() { //mesh
    ...
    const material = new THREE.MeshPhysicalMaterial({color: "#ff1030",
      
      transmission: 0, //유리처럼보임
      ior: 1.33, //굴절률
      thickness: 0.01,
      sheen: 0,
      sheenColor: "#00ff00",
    ...
    gui.add(material,"ior").min(0.99).max(4).step(0.01);
    gui.add(material,"thickness").min(0.001).max(2).step(0.001);
